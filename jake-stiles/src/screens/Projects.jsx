  ...
  return (
    <Layout>
      <div className='barbacide-div'>
        <h3>Barbacide App</h3>
        <a href='https://barbacide.netlify.app'>Live Site</a>
        <a href='https://github.com/jstiles44/barbacide-app'>Code Repository</a>
      ...
      <div className='playlist-div'>
        <h3>SongsYOÜ</h3>
        <a href='https://songsu.netlify.app'>Live Site</a>
        <a href='https://github.com/jstiles44/P3-Playlist-App'>Code Repository</a>
      ...
      <div className='record-review-div'>
        <h3>Record Review</h3>
        <a href='https://record-review.netlify.app'>Live Site</a>
        <a href='https://github.com/jstiles44/Record-Review'>Code Repository</a>
